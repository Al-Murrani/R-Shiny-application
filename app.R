...
ui <- fluidPage(theme = shinytheme("cerulean"),
                ...
                sidebarLayout(
                  ...
                  sidebarPanel(
                    ...
                    br(), br(),
                    h5("Built with",
                       img(src = "http://www.rstudio.com/wp-content/uploads/2014/04/shiny.png", height = "30px"),
                       "by",
                       img(src = "http://www.rstudio.com/wp-content/uploads/2014/07/RStudio-Logo-Blue-Gray.png", height = "30px"),
                       ".")
